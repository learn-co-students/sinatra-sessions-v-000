...
class App < Sinatra::Base
  ...
  get '/set_session' do
    #set session id here
    session[:id] = 1 # Why doesn't using the instance variable here work? You don't need an instance variable because the session hash is available in any controller route.
